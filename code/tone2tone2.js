...
var myBtnC="複製↓";
var mySample = "";
var myPs = "ps. 聲調符號 ˊ ˇ ˋ ˆ ⁺ ˈ 也可用 z v s x f l 替代。<br />　　一行只能放一條詞彙。";
...
if (myL == null) {
    ...
    myLang = "Goix_Z";
	biaoti.innerHTML = "詔安客語";
} else if (myL != "") {
    if (myL == "s") {
        myLang = "Goix_S";
		biaoti.innerHTML = "四縣客語";
    } else if (myL == "h") {
        myLang = "Goix_H";
		biaoti.innerHTML = "海陸客語";
    } else if (myL == "d") {
        myLang = "Goix_D";
		biaoti.innerHTML = "大埔客語";
    } else if (myL == "r") {
        myLang = "Goix_R";
		biaoti.innerHTML = "饒平客語";
    } else if (myL == "z") {
        myLang = "Goix_Z";
		biaoti.innerHTML = "詔安客語";
    } else if (myL == "m") {
        myLang = "Goix_M";
		biaoti.innerHTML = "閩南語(偏漳腔)";
    } else if (myL == "f") {
        myLang = "Goix_F";
		biaoti.innerHTML = "馬祖閩東語";
	}else{
		myLang = "Goix_Z";
		biaoti.innerHTML = "詔安客語";
	}
